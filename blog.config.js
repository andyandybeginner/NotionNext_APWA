...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Andy Gu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'APWA Client Portal', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://alphaprivatewealthadvisory.com/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Singapore Insurance, blog, money, investment, Singapore', // 网站关键词 英文逗号隔开
